...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    public class KeyboardValueKey : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // --- MODIFIED ---
            // Instead of defaulting to lowercase, we immediately check the keyboard's state.
            // This fixes the visual glitch on startup.
            if (NonNativeKeyboard.Instance != null)
            {
                Shift(NonNativeKeyboard.Instance.IsShifted || NonNativeKeyboard.Instance.IsCapsLocked);
            }
            else
            {
                m_Text.text = Value; // Fallback just in case
            }
            // --- END MODIFICATION ---
